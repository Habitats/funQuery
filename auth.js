...
// your own client id.
var OAUTH2_CLIENT_ID = '241126927340.apps.googleusercontent.com';
var OAUTH2_SCOPES = [ 'https://www.googleapis.com/auth/youtube' ];

// This callback is invoked by the Google APIs JS client automatically when it
// is loaded.
...
// OAUTH2_CLIENT_ID, then
// it will succeed with no user intervention. Otherwise, it will fail and the
// user interface
...
function handleAuthResult(authResult) {
	if (authResult) {
		// Auth was successful; hide the things related to prompting for auth
		// and show the things
		// that should be visible after auth succeeds.
		$('.pre-auth').hide();
		loadAPIClientInterfaces();
	} else {
		// Make the #login-link clickable, and attempt a non-immediate OAuth 2
		// client flow.
...
// This is required before using the Google APIs JS client; more info is
// available at
...
function loadAPIClientInterfaces() {
	...
	print("loadAPIClientInterface", 1);
}